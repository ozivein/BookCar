...
namespace UdemyCarBook.WebUI.ViewComponents.BlogViewComponents
{
    public class _BlogDetailsTagCloudComponenentPartial : ViewComponent
    {
        ...
        public _BlogDetailsTagCloudComponenentPartial(ITagCloudConsumeApiService tagCloudConsumeApiService, IDataProtectionProvider dataProtector, ISharedAuthorizationApiService shared)
        {
